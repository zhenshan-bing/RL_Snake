...
def run_environment_episode(env, max_timesteps, render, lambda_deg=120, alpha_deg=90, w_para=0.5, y_para=0.1):
    ...
    while (not done) and number_of_timestep < max_timesteps:
        ...
        # if number_of_timestep > 500:
        #     # print("change color")
        #     env.unwrapped.sim.model.geom_rgba[1] = [0., 1, 0, 1]
        # print(env.unwrapped.sim.model.geom_rgba[2])
...
def enjoy(env_id):
    ...
    # print(dir(env.unwrapped.sim.model.geom_rgba))
